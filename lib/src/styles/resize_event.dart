...
typedef EventResizeCallback<E extends FlutterWeekViewEventMixin> = Function(E event, DateTime newEndTime);
...
class ResizeEventOptions<E extends FlutterWeekViewEventMixin> {
